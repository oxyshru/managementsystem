...
import {
    User, Player, Coach, Game, Batch, Payment, TrainingSession, Attendance, PerformanceNote, PlayerStats, // Added PlayerStats
    UserSeed, PlayerSeed, CoachSeed, GameSeed, BatchSeed, PaymentSeed, TrainingSessionSeed, AttendanceSeed, PerformanceNoteSeed, PlayerGameSeed // Import the specific Seed types
...
const initialSeedData: {
    ...
    payments: [
        ...
        { id: 1, player_id: 1, date: '2025-04-15', amount: 150.00, description: 'Monthly Fee' }, // Use snake_case for DB columns
        { id: 2, player_id: 1, date: '2025-05-15', amount: 150.00, description: 'Monthly Fee' }, // Use snake_case for DB columns
        { id: 3, player_id: 2, date: '2025-05-20', amount: 150.00, description: 'Monthly Fee' }, // Use snake_case for DB columns
        { id: 4, player_id: 3, date: '2025-04-01', amount: 200.00, description: 'Registration Fee' }, // Use snake_case for DB columns
        { id: 5, player_id: 3, date: '2025-05-01', amount: 150.00, description: 'Monthly Fee' }, // Use snake_case for DB columns
    ],
    performance_notes: [
